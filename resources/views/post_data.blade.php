    ...
    <div class="container mt-3">
        ...
        @isset($sts)
            @php
                ...
                $fetchListing['notes'] = 'Hours: Mon-Fri 10 am-5pm |
Closed Sunday  Call Office : 908 235 8986 
Rick -  CALL OR TEXT 908 235 8986';
                $details_arry = ['RGT Restaurant Equipment', '1548 Route 9', 'Toms River', 'NJ', '08755', '908 235 8986', 'rgt_equip@yahoo.com', 'Rick'];
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card mt-1">
                        <div class="card-body">
                            ...
                            <form method="post" action="add_listing" enctype="multipart/form-data"
                                class="ajax-form-with-file-listing">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="title"
                                                value="{{ @$fetchListing['title'] }}" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Manufacture"
                                                value="{{ @$fetchListing['manufacture'] }}" class="form-control"
                                                name="manufacture" autocomplete="off">
                                        </div><!-- form-group -->
                                    </div><!-- col -->
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="">Model</label>
                                            <input type="text" placeholder="Model" value="" class="form-control"
                                            ...
                                            @for ($i = 0; $i < 5; $i++)
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($features[$i]) ? $features[$i] : '' }}"
                                                        name="features[]" id="basic-url" aria-describedby="basic-addon3">
                                                </div>
                                            @endfor
                                        </div><!-- form-group -->
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" id="" cols="30" rows="5"
                                                placeholder="Any Miscellaneous Notes (Optional)" class="form-control">{{ @strip_tags(nl2br($fetchListing['notes'])) }}</textarea>
                                        </div>
                                    </div><!-- col -->
                                    <div class="col-sm-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"
                                                        id="basic-addon3">{{ ucwords($detail) }}</span>
                                                </div>
                                                <input type="text" value="{{ @$details_arry[$key] }}"
                                                    class="form-control" name="{{ strtolower($detail) }}" id="basic-url"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="$$$"
                                                value="{{ @$fetchListing['price'] }}" class="form-control"
                                                name="price">
                                        </div><!-- form-group -->
                                    </div><!-- col -->
                                </div><!-- row -->
